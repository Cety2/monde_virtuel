...
setup(
    ...
    description='Une bibliothèque python du Système de simulation Décentralisé des Agents Virtuels Autonomes. Les agents apprennent, intéraggissent et collaborent en temps réel selon un Codex des Lois Intelligentes.',
